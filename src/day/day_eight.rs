...
pub fn main() {
    let input = include_str!("../data/day-eight.txt");
    ...
    println!("Dia 8: Collinearidade Ressonante: PART ONE - ANSWER {}", p1.len());
    ...
    println!("Dia 8: Collinearidade Ressonante: PART TWO - ANSWER {}", p2.len());
}